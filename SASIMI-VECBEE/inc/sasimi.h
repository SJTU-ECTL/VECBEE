...
public:
    ...
    void GreedySelectionInaccurate(Abc_Ntk_t * pOriNtk, std::string outPrefix);
    ...
    void CollectAllLACsUnderERInaccurate(IN Simulator_t & oriSmlt, IN Simulator_t & appSmlt, IN std::vector < std::vector <tVec> > & bds, IN std::vector <Vec_Ptr_t * > & vMffcs, OUT std::vector <LAC_t> & nodeLACs);
    ...
    void CollectNodeLACUnderERInaccurate(IN Abc_Obj_t * pTS, IN Simulator_t & oriSmlt, IN Simulator_t & appSmlt, IN std::vector <tVec> & sources, IN std::vector <Vec_Ptr_t * > & vMffcs, IN int baseER, OUT LAC_t & nodeLAC);
    ...
    void SortCandLACs(IN std::vector <LAC_t> & nodeLACs, OUT std::vector <LAC_t> & candLACs);
    ...
    int ApplyBestLACInaccurate(Simulator_t & oriSmlt, Simulator_t & appSmlt, std::vector <LAC_t> & candLACs, int topNum, std::string outPrefix, unsigned seed);
    ...
    void GetDERInaccurate(IN Simulator_t & appSmlt, IN Abc_Obj_t * pTS, IN Abc_Obj_t * pSS, OUT std::pair <int, int> & errors);
